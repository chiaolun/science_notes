	...
	- Electronic structure
		...
		- Solving for the Hydrogen Atom
			...
			- Enumeration rules of the three quantum numbers for hydrogen
				...
				- These quantum numbers collectively describe the unique quantum state of an electron in the hydrogen atom.The three quantum numbers for hydrogen are the principal quantum number (n), the azimuthal (or angular momentum) quantum number (l), and the magnetic quantum number (m_l). Here are the enumeration rules for each:
