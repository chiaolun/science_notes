	...
	- Thermodynamics
		- Three Laws of Thermodynamics
			...
			- As the temperature of a system approaches absolute zero, the entropy of a perfect crystal approaches zero.
			  logseq.order-list-type:: number
		- Carnot Engine (1824)
			- Theoretical engine proposed by Sadi Carnot, . Engines are machines that convert heat into work.
			- Set up: https://www.youtube.com/watch?v=DxL2HoqLbyA&t=240s
			- https://en.wikipedia.org/wiki/Carnot_heat_engine#Carnot_cycle
			-
