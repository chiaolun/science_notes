		...
		- Covalent
			- Sharing of electrons between atoms
				- H2 example
					...
					- Approximations were used to make this possible, and the value was way off as a result, but it showed that sharing electrons would allow the electrons to reach a lower energy, and that bonding was possible.
