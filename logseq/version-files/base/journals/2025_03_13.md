- [[2025-03-13]] [[Talk track]]
	- Electronic structure
		...
		- Solving for the Hydrogen Atom
			...
			- Enumeration rules of the three quantum numbers for hydrogen, succinct
				- The three quantum numbers for hydrogen are the principal quantum number (n), the azimuthal (or angular momentum) quantum number (l), and the magnetic quantum number (m_l). Here are the enumeration rules for each:
				  ...
				  2. **Azimuthal Quantum Number (l):**
				     ...
				     - Corresponds to specific types of orbitals: \( l = 0 \) (s orbital), \( l = 1 \) (p orbital), \( l = 2 \) (d orbital), \( l = 3 \) (f orbital), etc.
				  
				  3. **Magnetic Quantum Number (m_l):**
				     - Values: \( m_l = -l, -(l-1), \ldots, 0, \ldots, (l-1), l \)
				     - Specifies the orientation of the orbital in space.
				  
				  These quantum numbers collectively describe the unique quantum state of an electron in the hydrogen atom.
		- Many-body - Fermions
